...
For a Lit component class that you import directly, use
[island registration](/docs/rendering/islands/). Use server rendering only when
the component and its dependencies can render under Lit's server renderer.
Browser-only libraries should stay client rendered.
